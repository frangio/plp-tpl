...
\usepackage{caratula}
\usepackage{verbatim}
\lhead{Paradigmas de Programación}% {Con esto se usa el header copado. También está \chead para
\rhead{Trabajo Práctico 2} 	% el centro y comandos para el pie de página, buscar fancyhdr}
