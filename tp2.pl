...
:- tablero(ej5x5, T), camino3(pos(0, 0), pos(2, 3), T, [pos(0, 0), pos(0, 1), pos(0, 2), pos(0, 3), pos(1, 3), pos(2, 3)]).
:- tablero(ej5x5, T), findall(Camino, camino3(pos(0,0),pos(2,3),T,Camino), Caminos), length(Caminos,2).
